...
function AdminViewPostedMovies() {
    ...
    const currentmovie = movies.slice(offset, offset + moviePerPage);
        ...
        <div className="row g-0">
          <div className="col-md-4">
            <img
              ...
              alt={movie.title}
              style={{
                maxWidth: '200px', margin: '30px', borderRadius: '10px',
          ...
          <div className="col-md-8">
            <div className="card-body">
              ...
              <p className="card-text"><strong>Production:</strong> {movie.production}</p>
